...
// Device dependant defines only 

#if defined(__AT90Mega169__) | defined(__ATmega169P__) | \
...
/*__x__*/ unsigned char USI_TWI_Start_Transceiver_With_Data( unsigned char * , unsigned char );
unsigned char USI_TWI_Get_State_Info( void );
void	__delay_cycles(uint16_t __count);
